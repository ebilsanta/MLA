...
if __name__ == '__main__':
    ...
    # batch_size, k_subbands, t_timesteps, input_dim = 256, 41, 259, 128
    ...
    # added DataParallel to use multi GPUs (original code above)
    model = BandTransformerModelModule(**cfg)
