...
Make sure python version = 3.10, otherwise install the latest version [here](https://www.python.org/downloads/)


### Setting up virtual environment (DONE, DON'T NEED TO DO AGAIN)
...
### After initial setup done (ALWAYS DO THIS EVERY SESSION)
...
2. Remember to install modules in requirements.txt again if other team members have made changes
   ```sh
   pip install -r requirements.txt
...
3. Set Environment Variable
   ```sh
    ...
    <!-- # or change to your own wandb API key -->
    ALTERNATIVES
    export MUSDB_DIR="/common/home/projectgrps/IS460/IS460G4/datasets/processed_csd_converted_to_stereo"
    export MUSDB_DIR="/common/home/projectgrps/IS460/IS460G4/datasets/musdb18hq_sample"

### DOING THE TRAINING

1. Check the datasets are in the correct locations
   ```sh
   processed_csd_converted_to_stereo should be in:
   /common/home/projectgrps/IS460/IS460G4/datasets/processed_csd_converted_to_stereo
   otherwise run:
   /common/home/projectgrps/IS460/IS460G4/datasets/preprocess_csd_like_musdb.py
   and
   /common/home/projectgrps/IS460/IS460G4/datasets/batch_convert_mono_to_stereo.py

   combined_processed_dataset_converted_stereo should be in: # FINAL TO BE USED (CSD + ESMUC)
   /common/scratch/projectgrps/IS460/IS460G4/datasets/combined_processed_dataset_converted_stereo

2. Preprocess the dataset (choose one below)
   ```sh
   python3 prepare_dataset.py -i /common/home/projectgrps/IS460/IS460G4/datasets/processed_csd_converted_to_stereo -o /common/home/projectgrps/IS460/IS460G4/datasets/bsrnn_trial_output -t bass drums vocals other
   AND
   python3 prepare_dataset.py -i /common/home/projectgrps/IS460/IS460G4/datasets/processed_csd_converted_to_stereo -o /common/home/projectgrps/IS460/IS460G4/datasets/bsrnn_trial_output --split valid -t bass drums vocals other
   AND
   python3 prepare_dataset.py -i /common/home/projectgrps/IS460/IS460G4/datasets/processed_csd_converted_to_stereo -o /common/home/projectgrps/IS460/IS460G4/datasets/bsrnn_trial_output --subset test -t bass drums vocals other


   python3 prepare_dataset.py -i /common/home/projectgrps/IS460/IS460G4/datasets/musdb18hq_sample -o /common/home/projectgrps/IS460/IS460G4/datasets/bsrnn_trial_output -t bass drums vocals other
   AND
   python3 prepare_dataset.py -i /common/home/projectgrps/IS460/IS460G4/datasets/musdb18hq_sample -o /common/home/projectgrps/IS460/IS460G4/datasets/bsrnn_trial_output --subset test -t bass drums vocals other
   AND
   python3 prepare_dataset.py -i /common/home/projectgrps/IS460/IS460G4/datasets/musdb18hq_sample -o /common/home/projectgrps/IS460/IS460G4/datasets/bsrnn_trial_output --split valid -t bass drums vocals other


   python3 prepare_dataset.py -i /common/scratch/projectgrps/IS460/IS460G4/datasets/combined_processed_dataset_converted_stereo -o /common/home/projectgrps/IS460/IS460G4/datasets/bsrnn_preprocess_production_csd_esmuc -t bass drums vocals other
   AND
   python3 prepare_dataset.py -i /common/scratch/projectgrps/IS460/IS460G4/datasets/combined_processed_dataset_converted_stereo -o /common/home/projectgrps/IS460/IS460G4/datasets/bsrnn_preprocess_production_csd_esmuc --subset test -t bass drums vocals other
   AND
   python3 prepare_dataset.py -i /common/scratch/projectgrps/IS460/IS460G4/datasets/combined_processed_dataset_converted_stereo -o /common/home/projectgrps/IS460/IS460G4/datasets/bsrnn_preprocess_production_csd_esmuc --split valid -t bass drums vocals other

Check your output directory and see if all the .txt files are there and are not empty (except those with '_valid' suffix)
Move the ones you want to use for training to /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/src/files

3. Train RUN ALL 4 BELOW (submit job guide: https://violet.smu.edu.sg/origami/students/#sample-submission-script-advanced https://violet.smu.edu.sg/origami/interactivejobs/ ) 
   ```sh
...
srun --gres=gpu:2 python /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/src/train.py train_dataset.target=bass model=bandsplitrnnbass
...
srun --gres=gpu:2 python /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/src/train.py train_dataset.target=drums model=bandsplitrnndrums

   python /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/src/train.py train_dataset.target=other
srun --gres=gpu:2 python /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/src/train.py train_dataset.target=other

4. Inference
   ```sh
   <!-- for trial musdbhqsample vocals -->
   python3 inference.py -i /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_inference_output/AClassicEducation_NightOwl.wav -o /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_inference_output/inference_musdbhqsample/ -t vocals -c /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_saved_models/trained_on_musdbhqsample/vocals/weights/BEST_epoch376-train_loss0.40.ckpt -d cuda
   <!-- with production data (CSD + esmuc) need to change the ckpt argument-->
   python3 inference.py -i /common/scratch/projectgrps/IS460/IS460G4/datasets/combined_processed_dataset_converted_stereo/test/Mix1/mixture.wav -o /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_inference_output/inference_csd_esmuc/ -t vocals -c /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_saved_models/trained_on_csd_esmuc/vocals/weights/BEST_epoch376-train_loss0.40.ckpt -d cuda
...
5. Evaluation
  - -d RUN_DIR refers to the logs folder created (contain /tb_logs and /weights)
  - see evaluate.py line 18-19
   ```sh
   python3 evaluate.py -d /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_saved_models/trained_on_musdbhqsample/vocals --device cuda --ckpt BEST_epoch376-train_loss0.40.ckpt

### Random notes for future
1. Source Activity Detector (SAD), the algo used for the pre-processing is used to remove silent parts and keep significant regions only
2. BSRNN also uses some form of Data Augmentation, randomly mixing stems from different songs
3. Loss function used:
  - SUM(frequency-domain MAE, time-domain MAE)
4. Evaluation metrics:
  - uSDR
  - cSDR --> the more standard one used for Source Separation tasks
5. Mapping used:
   ```sh
    output_mapping = {
        "bass": "bass",
...
# Original github repo starts from here https://github.com/crlandsc/Music-Demixing-with-Band-Split-RNN
