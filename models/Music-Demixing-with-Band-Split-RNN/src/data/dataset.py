...
class SourceSeparationDataset(Dataset):
    ...
    def load_files(
        ...
        # print('DEBUG fp_template:', fp_template)
    ...
    def mix_segments(
        ...
        for target in targets_to_add:
            ...
            # print('mix_segment:', mix_segment)
            # print('mix_segment shape:', mix_segment.shape)
            # print('segment_to_add:', segment_to_add)
            # print('segment_to_add shape:', segment_to_add.shape)
    ...
    def __getitem__(
        ...
        # mix_segment, tgt_segment = self.augment(mix_segment, tgt_segment) # original code
        try:
