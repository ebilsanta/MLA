...
#SBATCH --job-name=bsrnnPreprocessAudioProduction     # Give the job a name
...
srun --gres=gpu:1 python3 prepare_dataset.py -i /common/scratch/projectgrps/IS460/IS460G4/datasets/combined_processed_dataset_converted_stereo -o /common/home/projectgrps/IS460/IS460G4/datasets/bsrnn_preprocess_production_csd_esmuc -t bass drums vocals other

# CODES TO WRITE INTO UR TERMINAL
# chmod +x /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/run_preprocess.sh
# sbatch /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/run_preprocess.sh