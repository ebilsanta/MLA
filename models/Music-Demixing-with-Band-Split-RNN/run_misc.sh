...
#SBATCH --output=/common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/smu_sbatch_job_logs/misc_job_logs/%u.%j.out          # Where should the log files go?
...
#SBATCH --job-name=bsrnnPreProcessESDandEsmuc     # Give the job a name
...
cd /common/home/projectgrps/IS460/IS460G4/datasets
...
srun --gres=gpu:1 python /common/home/projectgrps/IS460/IS460G4/datasets/preprocess_csd_and_esmuc.py

# CODES TO WRITE INTO UR TERMINAL
# chmod +x /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/run_misc.sh
# sbatch /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/run_misc.sh