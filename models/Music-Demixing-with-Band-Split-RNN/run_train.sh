...
#SBATCH --job-name=bsrnnTrainOnProductionDataBass     # Give the job a name
...
# vocals
# srun --gres=gpu:2 python /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/src/train.py
# bass
...
# chmod +x /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/run_train.sh
# sbatch /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/run_train.sh