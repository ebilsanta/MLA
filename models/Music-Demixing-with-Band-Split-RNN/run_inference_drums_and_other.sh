...
#SBATCH --job-name=bsrnnInferDrumsTrainedProductionData     # Give the job a name
...
# chmod +x /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/run_inference_drums_and_other.sh
# sbatch /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/run_inference_drums_and_other.sh