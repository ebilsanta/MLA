...
#SBATCH --job-name=bsrnnInferVocalsTrainedProductionData     # Give the job a name
...
# for cantoria
srun --gres=gpu:1 python3 inference.py -i /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_inference_output/cantoria_to_infer_mix1.wav -o /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_inference_output/inference_production_csd_esmuc/ -t vocals -c /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_saved_models/trained_on_production_csd_esmuc/vocals/weights/epoch53-train_loss0.33.ckpt -d cuda
srun --gres=gpu:1 python3 inference.py -i /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_inference_output/cantoria_to_infer_mix2.wav -o /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_inference_output/inference_production_csd_esmuc/ -t vocals -c /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_saved_models/trained_on_production_csd_esmuc/vocals/weights/epoch53-train_loss0.33.ckpt -d cuda
# for csd_esmuc
srun --gres=gpu:1 python3 inference.py -i /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_inference_output/csd_esmuc_to_infer_mix1.wav -o /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_inference_output/inference_production_csd_esmuc/ -t vocals -c /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_saved_models/trained_on_production_csd_esmuc/vocals/weights/epoch53-train_loss0.33.ckpt -d cuda
srun --gres=gpu:1 python3 inference.py -i /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_inference_output/csd_esmuc_to_infer_mix2.wav -o /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_inference_output/inference_production_csd_esmuc/ -t vocals -c /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_saved_models/trained_on_production_csd_esmuc/vocals/weights/epoch53-train_loss0.33.ckpt -d cuda

# CODES TO WRITE INTO UR TERMINAL
# chmod +x /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/run_inference_vocals.sh
# sbatch /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/run_inference_vocals.sh