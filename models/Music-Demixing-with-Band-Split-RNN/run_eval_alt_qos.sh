...
# vocals
# srun --gres=gpu:1 python3 evaluate.py -d /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_saved_models/trained_on_production_csd_esmuc/vocals --device cuda --ckpt epoch53-train_loss0.33.ckpt
#bass
srun --gres=gpu:1 python3 evaluate.py -d /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/bsrnn_saved_models/trained_on_production_csd_esmuc/bass --device cuda --ckpt epoch25-train_loss0.36.ckpt

# CODES TO WRITE INTO UR TERMINAL
# chmod +x /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/run_eval_alt_qos.sh
# sbatch /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/run_eval_alt_qos.sh