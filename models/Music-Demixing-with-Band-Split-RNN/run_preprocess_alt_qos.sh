...
#SBATCH --output=/common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/smu_sbatch_job_logs/preprocess_audio_job_logs/%u.%j.out          # Where should the log files go?
...
#SBATCH --job-name=bsrnnPreprocessAudioProductionTestAndValidSplit     # Give the job a name
...
# for test split
# srun --gres=gpu:1 python3 prepare_dataset.py -i /common/scratch/projectgrps/IS460/IS460G4/datasets/combined_processed_dataset_converted_stereo -o /common/home/projectgrps/IS460/IS460G4/datasets/bsrnn_preprocess_production_csd_esmuc --subset test -t bass drums vocals other
# for valid split
srun --gres=gpu:1 python3 prepare_dataset.py -i /common/scratch/projectgrps/IS460/IS460G4/datasets/combined_processed_dataset_converted_stereo -o /common/home/projectgrps/IS460/IS460G4/datasets/bsrnn_preprocess_production_csd_esmuc --split valid -t bass drums vocals other

# CODES TO WRITE INTO UR TERMINAL
# chmod +x /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/run_preprocess_alt_qos.sh
# sbatch /common/home/projectgrps/IS460/IS460G4/Music-Demixing-with-Band-Split-RNN/run_preprocess_alt_qos.sh