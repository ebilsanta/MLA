...
channel_name_list = ["bass"]  # ,"rest","bass","drums"]
channel_id_list = ["_4"]  # ,"_3","_2","_1"]
# "trained_20K", "trained_40K", "trained_60K", "trained_80K"]
checkpoint_list = ["trained_1"]
...
for channel_name, channel_id in zip(channel_name_list, channel_id_list):
    ...
    for file_des in checkpoint_list:
        ...
        ###### renamed the url according to our repo structure #####
        files = [f for f in listdir("/common/home/projectgrps/IS460/IS460G4/unmix/unmix/data/test"+channel_id+"/")
                 if isfile(join("/common/home/projectgrps/IS460/IS460G4/unmix/unmix/data/test"+channel_id+"/", f))]
        files.sort()
        ...
        for j, file in enumerate(files):
            ...
            try:
                x_in, _ = librosa.load("/common/home/projectgrps/IS460/IS460G4/unmix/unmix/data/test" +
