...
vqvae = Hyperparams(
    ...
    l_bins=2048,
    l_mu=0.99,
    commit=0.05, #NEW: was 0.02
    spectral=0.25, #NEW: Was 0.0
    multispectral=1.0, 
...
DEFAULTS["data"] = Hyperparams(
    audio_files_dir='',
    stem_audio_dir='',  #NEW: parameter for the directory of stem audios
    finetune='',
    english_only=False,
    bs=1,
    bs_sample=1,
...
DEFAULTS["opt"] = Hyperparams(
    ...
    lr=0.001, #NEW: Changed from 0.0003 
    clip=1.0,
    beta1=0.9,
    beta2=0.999, 
    ignore_grad_norm=0,
    ...
    eps=1e-08,
    lr_warmup=100.0,
    lr_decay=10, #NEW: Apply decay every iteration, adjust if needed. Original was 10000000000.0
    lr_gamma= 0.9999, #NEW: original was 1.0
    lr_scale=1.0,
