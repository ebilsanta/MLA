...
# Run your command
srun python unmix/train.py --hps=vqvae --name=vqvae_bass_b6 --sr=44100 --sample_length=393216 --bs=6 --audio_files_dir="unmix/data/bass" --labels=False --train --aug_shift --aug_blend
